...
router.get(
    "/dashboard/addVillage/:playerTag",
    requireAuth,
    getVillageController
);

router.get("/dashboard/overview", requireAuth, getVillageOverviewsController);

router.post(
    "/dashboard/addVillage/add",
    requireAuth,
    addVillageDetailController
);
...
router.get(
    "/:id",
    requireAuth,
    ensureAccountAccessFromParam("id"),
    getAccountDetail
);
