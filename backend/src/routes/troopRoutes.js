...
router.get(
    "/:id",
    requireAuth,
    ensureTroopOwnershipFromParam("id"),
    getTroopByIdController
);
...
router.post(
    "/:accountId/:troopId/upgrade/start",
    requireAuth,
    ensureAccountAccessFromParam("accountId"),
...
router.post(
    "/:accountId/:troopId/upgrade/finish",
    requireAuth,
    ensureAccountAccessFromParam("accountId"),
    ensureTroopOwnershipFromParam("troopId"),
    finishTroopUpgradeController
...
router.post(
    "/:accountId/:troopId/upgrade/cancel",
    requireAuth,
    ensureAccountAccessFromParam("accountId"),
    ensureTroopOwnershipFromParam("troopId"),
    cancelTroopUpgradeController
