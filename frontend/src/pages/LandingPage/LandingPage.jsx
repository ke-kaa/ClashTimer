		...
		<div className="landing-page min-h-screen relative flex bg-cover bg-center bg-no-repeat flex-col items-center justify-center p-[20px]">
			...
			<div className="features-section flex gap-18">
				<div className="feature-card">
					...
					<p className="feature-desc">Set smart timers and never miss an upgrade.</p>
				</div>

				<div className="feature-card">
					<div className="feature-icon relative top-[-70px]">
						<img src={skeletonSpell} alt="Progress" className='skel-1 '/>
						<img src={skeletonSpell} alt="Progress" className='skel-2 '/>
						<img src={skeletonSpell} alt="Progress" />
					</div>
					<h3 className="feature-title">Progress Tracker</h3>
					<p className="feature-desc">Visualize your village growth step by step.</p>
				</div>

				<div className="feature-card">
					<div className="feature-icon strategy-icons relative top-[-60px] gap-0">
						<img src={axe} alt="Axe" className='valk-axe absolute ' />
						<img src={sword} alt="Sword"  className='sword left-[-55px]' />
					</div>
					<h3 className="feature-title">Strategy Planner</h3>
					<p className="feature-desc">Plan upgrades to optimize attacks and defense.</p>
				</div>
			</div>
		</div>
    )
