...
export default function EditUpgradeTime({ currentDuration, onEdit, onClose }) {
    ...
    const limits = { days: 20, hours: 23, minutes: 59 };
    ...
    const handleUpgrade = () => {
        const normalized = {
            days: Number(duration.days || currentDuration.days) || 0,
            hours: Number(duration.hours || currentDuration.hours) || 0,
            minutes: Number(duration.minutes || currentDuration.minutes) || 0,
        };

        const totalSeconds =
            normalized.days * 24 * 3600 +
            normalized.hours * 3600 +
